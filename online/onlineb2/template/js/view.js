...
showData = (items) => {
    ...
    items.forEach((item, index) => {
        ...
        xhtlm       +=       `<tr>
                                    ...
                                    <td>
                                        <button type="button" onclick = "showItemsEdit('${item.id}')" class="btn btn-warning">Edit</button>
                                        <button type="button" onclick = "deleteItems('${item.id}')"   class="btn btn-danger">Delete</button>
                                    </td>
                                </tr>`;
